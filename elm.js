...
Elm.DataModel.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var maxPaneBuildUp = function (pane) {
      var _p0 = pane;
      switch (_p0.ctor)
      {case "ShellPane": return $List.length(_p0._0.content);
         case "EditorPane": return $List.length(_p0._0.content);
         default: return $List.length(_p0._0.content);}
   };
   var maxBuildUp = function (layout) {
      var _p1 = layout;
      if (_p1.ctor === "Just") {
            switch (_p1._0.ctor)
            {case "TwoPanesStep": var _p2 = _p1._0._0;
                 return A2($Basics.max,maxPaneBuildUp(_p2.leftPane),maxPaneBuildUp(_p2.rightPane));
               case "SinglePaneStep": return maxPaneBuildUp(_p1._0._0.pane);
               default: return 1;}
         } else {
            return 1;
         }
   };
   var maxSlideBuildUp = F2(function (i,slides) {    return maxBuildUp(A2($Array.get,i,slides)) - 1;});
   var foldBuildup = F2(function (next,acc) {
      var _p3 = next;
      switch (_p3.ctor)
      {case "Reuse": return acc;
         case "Single": return _U.list([_p3._0]);
         case "Replace": return _U.list([_p3._0]);
         case "Append": return A2($Basics._op["++"],acc,_U.list([_p3._0]));
         case "ReplaceLast": return A2($Basics._op["++"],A2($List.take,$List.length(acc) - 1,acc),_U.list([_p3._0]));
         default: return A2($Basics._op["++"],A2($List.take,$List.length(acc) - _p3._0,acc),_U.list([_p3._1]));}
   });
   var evaluateBuildUp = F2(function (n,allBuildups) {
      var buildups = A2($List.take,n + 1,allBuildups);
      return A2($String.join,"",A3($List.foldl,foldBuildup,_U.list([]),buildups));
   });
   var ReplaceLastN = F2(function (a,b) {    return {ctor: "ReplaceLastN",_0: a,_1: b};});
   var ReplaceLast = function (a) {    return {ctor: "ReplaceLast",_0: a};};
   var Append = function (a) {    return {ctor: "Append",_0: a};};
   var Replace = function (a) {    return {ctor: "Replace",_0: a};};
   var Single = function (a) {    return {ctor: "Single",_0: a};};
   var Reuse = {ctor: "Reuse"};
   var ImageStep = function (a) {    return {ctor: "ImageStep",_0: a};};
   var SinglePaneStep = function (a) {    return {ctor: "SinglePaneStep",_0: a};};
   var TwoPanesStep = function (a) {    return {ctor: "TwoPanesStep",_0: a};};
   var HeaderPane = function (a) {    return {ctor: "HeaderPane",_0: a};};
   var EditorPane = function (a) {    return {ctor: "EditorPane",_0: a};};
   var ShellPane = function (a) {    return {ctor: "ShellPane",_0: a};};
   var Background = function (a) {    return {template: a};};
   return _elm.DataModel.values = {_op: _op
                                  ,Background: Background
                                  ,ShellPane: ShellPane
                                  ,EditorPane: EditorPane
                                  ,HeaderPane: HeaderPane
                                  ,TwoPanesStep: TwoPanesStep
                                  ,SinglePaneStep: SinglePaneStep
                                  ,ImageStep: ImageStep
                                  ,Reuse: Reuse
                                  ,Single: Single
                                  ,Replace: Replace
                                  ...
                                  ,ReplaceLastN: ReplaceLastN
                                  ,foldBuildup: foldBuildup
                                  ,maxSlideBuildUp: maxSlideBuildUp
                                  ,maxBuildUp: maxBuildUp
                                  ,maxPaneBuildUp: maxPaneBuildUp
                                  ,evaluateBuildUp: evaluateBuildUp};
};
Elm.TutorialStyles = Elm.TutorialStyles || {};
Elm.TutorialStyles.Styles = Elm.TutorialStyles.Styles || {};
Elm.TutorialStyles.Styles.make = function (_elm) {
   "use strict";
   _elm.TutorialStyles = _elm.TutorialStyles || {};
   _elm.TutorialStyles.Styles = _elm.TutorialStyles.Styles || {};
   if (_elm.TutorialStyles.Styles.values) return _elm.TutorialStyles.Styles.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var descriptionStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding-top",_1: "20px"}]));
   var topBarStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "-webkit-backface-visibility",_1: "hidden"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-background-clip",_1: "border-box"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-background-origin",_1: "padding-box"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-background-size",_1: "auto"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-transition-delay",_1: "0s"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-transition-duration",_1: "0.7s"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-transition-property",_1: "top"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-transition-timing-function",_1: "ease-in-out"}
                                                    ,{ctor: "_Tuple2",_0: "background-attachment",_1: "scroll"}
                                                    ,{ctor: "_Tuple2",_0: "background-clip",_1: "border-box"}
                                                    ,{ctor: "_Tuple2",_0: "background-color",_1: "rgb(237, 237, 237)"}
                                                    ,{ctor: "_Tuple2",_0: "background-image",_1: "none"}
                                                    ,{ctor: "_Tuple2",_0: "background-origin",_1: "padding-box"}
                                                    ,{ctor: "_Tuple2",_0: "background-size",_1: "auto"}
                                                    ,{ctor: "_Tuple2",_0: "border-bottom-color",_1: "rgb(211, 211, 211)"}
                                                    ,{ctor: "_Tuple2",_0: "border-bottom-style",_1: "solid"}
                                                    ,{ctor: "_Tuple2",_0: "border-bottom-width",_1: "1px"}
                                                    ,{ctor: "_Tuple2",_0: "color",_1: "rgb(67, 67, 67)"}
                                                    ,{ctor: "_Tuple2",_0: "display",_1: "block"}
                                                    ,{ctor: "_Tuple2",_0: "padding-bottom",_1: "10px"}
                                                    ,{ctor: "_Tuple2",_0: "padding-left",_1: "10px"}
                                                    ,{ctor: "_Tuple2",_0: "padding-top",_1: "10px"}
                                                    ,{ctor: "_Tuple2",_0: "transition-delay",_1: "0s"}
                                                    ,{ctor: "_Tuple2",_0: "transition-duration",_1: "0.7s"}
                                                    ,{ctor: "_Tuple2",_0: "transition-property",_1: "top"}
                                                    ,{ctor: "_Tuple2",_0: "transition-timing-function",_1: "ease-in-out"}
                                                    ,{ctor: "_Tuple2",_0: "z-index",_1: "1"}]));
   var completeStep = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "-webkit-background-clip",_1: "border-box"}
                                                     ,{ctor: "_Tuple2",_0: "-webkit-background-origin",_1: "padding-box"}
                                                     ,{ctor: "_Tuple2",_0: "-webkit-background-size",_1: "auto"}
                                                     ,{ctor: "_Tuple2",_0: "background-attachment",_1: "scroll"}
                                                     ,{ctor: "_Tuple2",_0: "background-clip",_1: "border-box"}
                                                     ...
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "background-image"
                                                      ,_1: "url(https://d13jv82ekraqyq.cloudfront.net/assets/bg-progress-link-filled-550b82cbc81eb5f56ff099f1a7b28b86.png)"}
                                                     ,{ctor: "_Tuple2",_0: "background-origin",_1: "padding-box"}
                                                     ,{ctor: "_Tuple2",_0: "background-size",_1: "auto"}
                                                     ,{ctor: "_Tuple2",_0: "color",_1: "rgb(85, 26, 139)"}
                                                     ,{ctor: "_Tuple2",_0: "cursor",_1: "auto"}
                                                     ,{ctor: "_Tuple2",_0: "display",_1: "block"}
                                                     ,{ctor: "_Tuple2",_0: "float",_1: "right"}
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "font-family"
                                                      ,_1: "OpenSansRegular, \'Helvetica Neue\', Helvetica, Arial, sans-serif"}
                                                     ,{ctor: "_Tuple2",_0: "font-size",_1: "10px"}
                                                     ,{ctor: "_Tuple2",_0: "height",_1: "24px"}
                                                     ,{ctor: "_Tuple2",_0: "list-style-image",_1: "none"}
                                                     ,{ctor: "_Tuple2",_0: "list-style-position",_1: "outside"}
   ...
   var incompleteStep = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "-webkit-background-clip",_1: "border-box"}
                                                       ,{ctor: "_Tuple2",_0: "-webkit-background-origin",_1: "padding-box"}
                                                       ,{ctor: "_Tuple2",_0: "-webkit-background-size",_1: "auto"}
                                                       ,{ctor: "_Tuple2",_0: "background-attachment",_1: "scroll"}
                                                       ,{ctor: "_Tuple2",_0: "background-clip",_1: "border-box"}
                                                       ...
                                                       ,{ctor: "_Tuple2"
                                                        ,_0: "background-image"
                                                        ,_1: "url(https://d13jv82ekraqyq.cloudfront.net/assets/bg-progress-link-00feefaa8cd9a07088d1118deeb4b27b.png)"}
                                                       ,{ctor: "_Tuple2",_0: "background-origin",_1: "padding-box"}
                                                       ,{ctor: "_Tuple2",_0: "background-size",_1: "auto"}
                                                       ,{ctor: "_Tuple2",_0: "color",_1: "rgb(0, 0, 238)"}
                                                       ,{ctor: "_Tuple2",_0: "cursor",_1: "auto"}
                                                       ,{ctor: "_Tuple2",_0: "display",_1: "block"}
                                                       ,{ctor: "_Tuple2",_0: "float",_1: "right"}
                                                       ,{ctor: "_Tuple2"
                                                       ...
                                                       ,{ctor: "_Tuple2",_0: "text-decoration",_1: "none"}
                                                       ,{ctor: "_Tuple2",_0: "width",_1: "18px"}]));
   var stepStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "-webkit-background-clip",_1: "border-box"}
                                                  ,{ctor: "_Tuple2",_0: "-webkit-background-origin",_1: "padding-box"}
                                                  ,{ctor: "_Tuple2",_0: "-webkit-background-size",_1: "auto"}
                                                  ,{ctor: "_Tuple2",_0: "background-attachment",_1: "scroll"}
                                                  ,{ctor: "_Tuple2",_0: "background-clip",_1: "border-box"}
                                                  ...
                                                  ,{ctor: "_Tuple2"
                                                   ,_0: "background-image"
                                                   ,_1: "url(https://d13jv82ekraqyq.cloudfront.net/assets/bg-progress-bar-filled-77f1716a0eefdfeceb005135e8a13705.png)"}
                                                  ,{ctor: "_Tuple2",_0: "background-origin",_1: "padding-box"}
                                                  ,{ctor: "_Tuple2",_0: "background-size",_1: "auto"}
                                                  ,{ctor: "_Tuple2",_0: "color",_1: "rgb(67, 67, 67)"}
                                                  ,{ctor: "_Tuple2",_0: "display",_1: "list-item"}
                                                  ,{ctor: "_Tuple2",_0: "float",_1: "left"}
                                                  ,{ctor: "_Tuple2",_0: "font-family",_1: "OpenSansRegular, \'Helvetica Neue\', Helvetica, Arial, sans-serif"}
                                                  ,{ctor: "_Tuple2",_0: "font-size",_1: "10px"}
                                                  ,{ctor: "_Tuple2",_0: "height",_1: "24px"}
                                                  ,{ctor: "_Tuple2",_0: "list-style-image",_1: "none"}
                                                  ,{ctor: "_Tuple2",_0: "list-style-position",_1: "outside"}
                                                  ...
                                                  ,{ctor: "_Tuple2",_0: "margin-right",_1: "0px"}
                                                  ,{ctor: "_Tuple2",_0: "margin-top",_1: "0px"}
                                                  ,{ctor: "_Tuple2",_0: "padding-bottom",_1: "0px"}
                                                  ,{ctor: "_Tuple2",_0: "padding-left",_1: "0px"}
                                                  ,{ctor: "_Tuple2",_0: "padding-right",_1: "0px"}
                                                  ,{ctor: "_Tuple2",_0: "padding-top",_1: "0px"}
                                                  ,{ctor: "_Tuple2",_0: "position",_1: "relative"}
                                                  ,{ctor: "_Tuple2",_0: "text-align",_1: "left"}
                                                  ,{ctor: "_Tuple2",_0: "width",_1: "36.09375px"}]));
   var stepperStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "color",_1: "rgb(67, 67, 67)"}
                                                     ,{ctor: "_Tuple2",_0: "display",_1: "block"}
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "font-family"
                                                      ,_1: "OpenSansRegular, \'Helvetica Neue\', Helvetica, Arial, sans-serif"}
   ...
   var titleStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "color",_1: "rgb(0, 0, 0)"}
                                                   ,{ctor: "_Tuple2",_0: "display",_1: "inline"}
                                                   ,{ctor: "_Tuple2",_0: "font-family",_1: "\'Helvetica Neue\', Helvetica, Arial, sans-serif"}
                                                   ,{ctor: "_Tuple2",_0: "font-size",_1: "13px"}
                                                   ,{ctor: "_Tuple2",_0: "font-style",_1: "normal"}
                                                   ,{ctor: "_Tuple2",_0: "font-variant",_1: "normal"}
                                                   ,{ctor: "_Tuple2",_0: "font-weight",_1: "normal"}
                                                   ,{ctor: "_Tuple2",_0: "height",_1: "auto"}
                                                   ,{ctor: "_Tuple2",_0: "line-height",_1: "30px"}
                                                   ,{ctor: "_Tuple2",_0: "position",_1: "relative"}
                                                   ,{ctor: "_Tuple2",_0: "text-align",_1: "center"}
                                                   ,{ctor: "_Tuple2",_0: "text-shadow",_1: "rgb(255, 255, 255) 0px 1px 0px"}]));
   var editorStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "-webkit-background-clip",_1: "border-box"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-background-origin",_1: "padding-box"}
                                                    ,{ctor: "_Tuple2",_0: "-webkit-background-size",_1: "auto"}
                                                    ,{ctor: "_Tuple2",_0: "background-attachment",_1: "scroll"}
                                                    ,{ctor: "_Tuple2",_0: "background-clip",_1: "border-box"}
                                                    ...
                                                    ,{ctor: "_Tuple2",_0: "background-origin",_1: "padding-box"}
                                                    ,{ctor: "_Tuple2",_0: "background-size",_1: "auto"}
                                                    ,{ctor: "_Tuple2",_0: "color",_1: "rgb(4, 4, 4)"}
                                                    ,{ctor: "_Tuple2",_0: "display",_1: "block"}
                                                    ,{ctor: "_Tuple2",_0: "font-family",_1: "Monaco, Courier, font-monospace"}
                                                    ,{ctor: "_Tuple2",_0: "font-size",_1: "14px"}
                                                    ,{ctor: "_Tuple2",_0: "font-style",_1: "normal"}
                                                    ,{ctor: "_Tuple2",_0: "font-variant",_1: "normal"}
                                                    ,{ctor: "_Tuple2",_0: "font-weight",_1: "normal"}
                                                    ,{ctor: "_Tuple2",_0: "height",_1: "600px"}
                                                    ,{ctor: "_Tuple2",_0: "line-height",_1: "23px"}
                                                    ,{ctor: "_Tuple2",_0: "margin-bottom",_1: "0px"}
                                                    ,{ctor: "_Tuple2",_0: "margin-left",_1: "0px"}
                                                    ,{ctor: "_Tuple2",_0: "margin-right",_1: "0px"}
                                                    ,{ctor: "_Tuple2",_0: "margin-top",_1: "0px"}
                                                    ,{ctor: "_Tuple2",_0: "overflow-y",_1: "auto"}
                                                    ,{ctor: "_Tuple2",_0: "padding-bottom",_1: "5px"}
                                                    ,{ctor: "_Tuple2",_0: "padding-left",_1: "5px"}
                                                    ,{ctor: "_Tuple2",_0: "padding-right",_1: "5px"}
                                                    ,{ctor: "_Tuple2",_0: "padding-top",_1: "5px"}]));
   var shellStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "-webkit-background-clip",_1: "border-box"}
                                                   ,{ctor: "_Tuple2",_0: "-webkit-background-origin",_1: "padding-box"}
                                                   ,{ctor: "_Tuple2",_0: "-webkit-background-size",_1: "auto"}
                                                   ,{ctor: "_Tuple2",_0: "background-attachment",_1: "scroll"}
                                                   ,{ctor: "_Tuple2",_0: "background-clip",_1: "border-box"}
                                                   ,{ctor: "_Tuple2",_0: "background-color",_1: "rgb(66, 66, 66)"}
                                                   ,{ctor: "_Tuple2",_0: "background-image",_1: "none"}
                                                   ,{ctor: "_Tuple2",_0: "background-origin",_1: "padding-box"}
                                                   ,{ctor: "_Tuple2",_0: "background-size",_1: "auto"}
                                                   ,{ctor: "_Tuple2",_0: "color",_1: "rgb(255, 255, 255)"}
                                                   ,{ctor: "_Tuple2",_0: "display",_1: "block"}
                                                   ,{ctor: "_Tuple2",_0: "font-family",_1: "Monaco, Courier, font-monospace"}
                                                   ,{ctor: "_Tuple2",_0: "font-size",_1: "14px"}
                                                   ,{ctor: "_Tuple2",_0: "font-style",_1: "normal"}
                                                   ...
                                                   ,{ctor: "_Tuple2",_0: "padding-right",_1: "5px"}
                                                   ,{ctor: "_Tuple2",_0: "padding-top",_1: "5px"}]));
   var shellTabStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: "rgb(239, 237, 238)"}
                                                      ,{ctor: "_Tuple2"
                                                       ,_0: "background-image"
                                                       ,_1: "-webkit-linear-gradient(top, rgb(239, 237, 238), rgb(193, 193, 193))"}
                                                      ,{ctor: "_Tuple2",_0: "border-bottom-color",_1: "rgb(67, 67, 67)"}
                                                      ,{ctor: "_Tuple2",_0: "border-bottom-left-radius",_1: "0px"}
                                                      ,{ctor: "_Tuple2",_0: "border-bottom-right-radius",_1: "0px"}
                                                      ,{ctor: "_Tuple2",_0: "border-bottom-style",_1: "none"}
                                                      ,{ctor: "_Tuple2",_0: "border-bottom-width",_1: "0px"}
                                                      ,{ctor: "_Tuple2",_0: "border-image-outset",_1: "0px"}
                                                      ,{ctor: "_Tuple2",_0: "border-image-repeat",_1: "stretch"}
                                                      ,{ctor: "_Tuple2",_0: "border-image-slice",_1: "100%"}
                                                      ,{ctor: "_Tuple2",_0: "border-image-source",_1: "none"}
                                                      ,{ctor: "_Tuple2",_0: "border-image-width",_1: "1"}
                                                      ,{ctor: "_Tuple2",_0: "border-left-color",_1: "rgb(98, 135, 164)"}
                                                      ,{ctor: "_Tuple2",_0: "border-left-style",_1: "solid"}
                                                      ,{ctor: "_Tuple2",_0: "border-left-width",_1: "1px"}
                                                      ,{ctor: "_Tuple2",_0: "border-right-color",_1: "rgb(98, 135, 164)"}
                                                      ,{ctor: "_Tuple2",_0: "border-right-style",_1: "solid"}
                                                      ,{ctor: "_Tuple2",_0: "border-right-width",_1: "1px"}
                                                      ,{ctor: "_Tuple2",_0: "border-top-color",_1: "rgb(98, 135, 164)"}
                                                      ,{ctor: "_Tuple2",_0: "border-top-left-radius",_1: "3px"}
                                                      ,{ctor: "_Tuple2",_0: "border-top-right-radius",_1: "3px"}
                                                      ,{ctor: "_Tuple2",_0: "border-top-style",_1: "solid"}
                                                      ,{ctor: "_Tuple2",_0: "border-top-width",_1: "1px"}
                                                      ,{ctor: "_Tuple2",_0: "color",_1: "rgb(67, 67, 67)"}
                                                      ,{ctor: "_Tuple2",_0: "display",_1: "block"}
                                                      ,{ctor: "_Tuple2"
                                                       ,_0: "font-family"
                                                      ...
                                                      ,{ctor: "_Tuple2",_0: "padding-top",_1: "0px"}
                                                      ,{ctor: "_Tuple2",_0: "position",_1: "relative"}
                                                      ,{ctor: "_Tuple2",_0: "zoom",_1: "1"}
                                                      ,{ctor: "_Tuple2",_0: "text-align",_1: "center"}]));
   var innerStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "color",_1: "rgb(67, 67, 67)"}
                                                   ,{ctor: "_Tuple2",_0: "display",_1: "block"}
                                                   ,{ctor: "_Tuple2",_0: "font-family",_1: "OpenSansRegular, \'Helvetica Neue\', Helvetica, Arial, sans-serif"}
                                                   ,{ctor: "_Tuple2",_0: "font-size",_1: "10px"}
                                                   ,{ctor: "_Tuple2",_0: "height",_1: "600"}
                                                   ,{ctor: "_Tuple2",_0: "margin-bottom",_1: "0px"}
                                                   ,{ctor: "_Tuple2",_0: "margin-left",_1: "0px"}
                                                   ,{ctor: "_Tuple2",_0: "margin-right",_1: "0px"}
                                                   ,{ctor: "_Tuple2",_0: "margin-top",_1: "0px"}
                                                   ,{ctor: "_Tuple2",_0: "padding-bottom",_1: "0px"}
                                                   ,{ctor: "_Tuple2",_0: "padding-left",_1: "60px"}
                                                   ,{ctor: "_Tuple2",_0: "padding-right",_1: "60px"}
                                                   ,{ctor: "_Tuple2",_0: "padding-top",_1: "0px"}]));
   var bodyStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "height",_1: "700px"}
                                                  ,{ctor: "_Tuple2",_0: "border-top-color",_1: "rgb(38, 89, 127)"}
                                                  ,{ctor: "_Tuple2",_0: "border-top-style",_1: "solid"}
                                                  ,{ctor: "_Tuple2",_0: "border-top-width",_1: "1px"}
                                                  ,{ctor: "_Tuple2",_0: "background-color",_1: "rgb(59, 132, 192)"}]));
   var headerStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "color",_1: "rgb(67, 67, 67"}
                                                    ,{ctor: "_Tuple2",_0: "height",_1: "200px"}
                                                    ,{ctor: "_Tuple2",_0: "max-width",_1: "80%"}
                                                    ,{ctor: "_Tuple2",_0: "line-height",_1: "25.600000381469727px"}
                                                    ,{ctor: "_Tuple2",_0: "font-size",_1: "16px"}
                                                    ,{ctor: "_Tuple2",_0: "margin-bottom",_1: "16px"}
                                                    ,{ctor: "_Tuple2",_0: "padding-left",_1: "60px"}
                                                    ,{ctor: "_Tuple2",_0: "padding-right",_1: "60px"}]));
   return _elm.TutorialStyles.Styles.values = {_op: _op
                                              ,headerStyle: headerStyle
                                              ,bodyStyle: bodyStyle
                                              ,innerStyle: innerStyle
                                              ,shellTabStyle: shellTabStyle
...
Elm.Story.make = function (_elm) {
       ...
       var _op = {};
       var story =
       _U.list([$DataModel.SinglePaneStep({header: $DataModel.HeaderPane({content: _U.list([$DataModel.Single("\n## Welcome to the ALICE O2 Primer tutorial.\nUse arrow keys to navigate.\n")
               ...
               ,$DataModel.SinglePaneStep({header: $DataModel.HeaderPane({content: _U.list([$DataModel.Single("\n## Setting up the environment\n\nOnce we have our O2 software built, we need to set up the environment in order to run O2 executables.\n")
                                                                                           ...
                                                                                           ,$DataModel.Append(" You can use `alienv load` to load the environment for a given\npackage and all its dependencies.\n")
               ...
               ,$DataModel.TwoPanesStep({header: $DataModel.HeaderPane({content: _U.list([$DataModel.Single("\n\n## The Sampler\n\nWe now pass to the implementation of the `Run()` method.\n")
                                        ...
                                        ,rightPane: $DataModel.EditorPane({filename: "examples/tutorial-1/AliceO2TutorialSampler.cxx"
                                                                          ,content: _U.list([$DataModel.Single("")
               ...
               ,$DataModel.TwoPanesStep({header: $DataModel.HeaderPane({content: _U.list([$DataModel.Single("\n\n## The Sink\n\nAlso for the Sink, we must derive from `FairMQDevice` and implement the\n`Run()` method.\n\nIn this case the implementation will simply receive the messages and\nprint them out. This is done by invoking the `Receive()` method of the\nchannel.\n\n")
                                                                                         ,$DataModel.Append(" The rest of the code is similar to the Sampler one, with\nthe inner loop for the `RUNNING` state.\n\n")])})
                                        ,leftPane: $DataModel.EditorPane({filename: "examples/tutorial-1/AliceO2TutorialSink.h"
                                        ...
                                        ,rightPane: $DataModel.EditorPane({filename: "examples/tutorial-1/AliceO2TutorialSink.cxx"
               ...
               ,$DataModel.SinglePaneStep({header: $DataModel.HeaderPane({content: _U.list([$DataModel.Single("\n\n## Creating the driver processes\n\nNow that we have two classes for our own `FairMQDevice`s, we need to\ncreate some boilerplate to be able to pass the (optional) arguments and\nlaunch start the devices. We will call these two executable `runSampler`\nand `runSink` respectively.\n\n")
                                                                                           ...
                                                                                           ,$DataModel.Append("- Create the map of channel from the configuration.\n")
                                                                                           ,$DataModel.Append("- Set the transport type and any other option found in the\nconfiguration.\n")
                                                                                           ,$DataModel.Append("- Initialise and transition the state machine until the\nmain loop is reached.\n")])})
                                          ,pane: $DataModel.EditorPane({filename: "examples/tutorial-1/runSampler.cxx"
                                                                       ,content: _U.list([$DataModel.Single("\n")
               ...
               ,$DataModel.TwoPanesStep({header: $DataModel.HeaderPane({content: _U.list([$DataModel.Single("\n  ## Creating the driver processes\n\n  The final sourcecode for the sampler can be found below with the similar one for the sink.\n  ")])})
                                        ,leftPane: $DataModel.EditorPane({filename: "examples/tutorial-1/runSampler.cxx"
                                                                         ,content: _U.list([$DataModel.Single("\n#include <iostream>\n\n#include \"boost/program_options.hpp\"\n\n#include \"FairMQLogger.h\"\n#include \"FairMQParser.h\"\n#include \"FairMQProgOptions.h\"\n#include \"AliceO2TutorialSampler.h\"\n\nusing namespace boost::program_options;\n\nint main(int argc, char** argv)\n{\n    AliceO2TutorialSampler sampler;\n    sampler.CatchSignals();\n\n    FairMQProgOptions config;\n\n    try\n    {\n        if (config.ParseAll(argc, argv))\n        {\n            return 0;\n        }\n\n        std::string filename = config.GetValue<std::string>(\"config-json-file\");\n        std::string id = config.GetValue<std::string>(\"id\");\n\n        config.UserParser<FairMQParser::JSON>(filename, id);\n\n        sampler.fChannels = config.GetFairMQMap();\n\n        LOG(INFO) << \"PID: \" << getpid();\n\n        sampler.SetTransport(config.GetValue<std::string>(\"transport\"));\n\n        sampler.SetProperty(AliceO2TutorialSampler::Id, id);\n\n        sampler.ChangeState(\"INIT_DEVICE\");\n        sampler.WaitForEndOfState(\"INIT_DEVICE\");\n\n        sampler.ChangeState(\"INIT_TASK\");\n        sampler.WaitForEndOfState(\"INIT_TASK\");\n\n        sampler.ChangeState(\"RUN\");\n        sampler.InteractiveStateLoop();\n    }\n    catch (std::exception& e)\n    {\n        LOG(ERROR) << e.what();\n        LOG(INFO) << \"Command line options are the following: \";\n        config.PrintHelp();\n        return 1;\n    }\n\n    return 0;\n}\n")])})
                                        ,rightPane: $DataModel.EditorPane({filename: "examples/tutorial-1/runSink.cxx"
               ...
               ,$DataModel.TwoPanesStep({header: $DataModel.HeaderPane({content: _U.list([$DataModel.Single("## Compiling\n\nIn order to compile in Alice O2 we rely on [CMake](https://cmake.org). You will need\nto add a `examples/tutorial-1/CMakeLists.txt` which specifies how to compile the to Device\ndriver processes.\n")
                                        ...
                                        ,rightPane: $DataModel.EditorPane({filename: "examples/tutorial-1/CMakeLists.txt"
               ...
               ,$DataModel.TwoPanesStep({header: $DataModel.HeaderPane({content: _U.list([$DataModel.Single("\n## Running\n\nWe can finally run our applications. Simply pass the configuration when\ninvoking them on the command line.\n")
                                        ...
                                        ,rightPane: $DataModel.ShellPane({content: _U.list([$DataModel.Single("\n$ runSink --id sink1 \\\n          --config-json-file examples/tutorial-1/config.json\n")
                                                                                           ,$DataModel.Reuse
...
Elm.O2Tutorial.make = function (_elm) {
       ...
       $String = Elm.String.make(_elm),
       $Task = Elm.Task.make(_elm),
       $TutorialStyles$Styles = Elm.TutorialStyles.Styles.make(_elm);
       var _op = {};
       var Enter = function (a) { return {ctor: "Enter",_0: a};};
       var Arrows = function (a) { return {ctor: "Arrows",_0: a};};
       var MoveToPage = F2(function (a,b) {
                           return {ctor: "MoveToPage",_0: a,_1: b};
                        });
       var NoOp = {ctor: "NoOp"};
       var title = F2(function (address,model) {
                      return A2($Html.div
                               ,_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                         ,_0: "margin-top"
                                                                         ,_1: "6px"}]))])
                               ,_U.list([A2($Html.span
                                           ,_U.list([A2($Html$Events.onClick,address,Arrows({x: -1,y: 0}))
                                                    ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                                     ,_0: "margin-right"
                                                                                     ,_1: "10px"}
                                                                                    ,{ctor: "_Tuple2",_0: "cursor",_1: "pointer"}]))])
                                           ,_U.list([$Html.text($String.fromChar(_U.chr("◀")))]))
                                        ,$Html.text(A2($Basics._op["++"]
                                                      ,"Section: "
                                                      ,A2($Basics._op["++"]
                                                         ,$Basics.toString(model.currentStep)
                                                         ,A2($Basics._op["++"]
                                                            ," / Step: "
                                                            ,$Basics.toString(model.currentBuildUp)))))
                                        ,A2($Html.span
                                           ,_U.list([A2($Html$Events.onClick,address,Arrows({x: 1,y: 0}))
                                                    ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                                     ,_0: "margin-left"
       ...
       var stepKind = F2(function (n,model) {
                         return _U.eq(n,0) ? $TutorialStyles$Styles.completeStep
                             : _U.cmp(n,model.currentStep) > 0
                             ? $TutorialStyles$Styles.incompleteStep
                             : $TutorialStyles$Styles.completeStep;
                      });
       var stepper = function (model) {
          var navigationButton = function (n) {
             return A2($Html.li
                      ,_U.list([$TutorialStyles$Styles.stepStyle])
                      ,_U.list([A2($Html.a
          ...
          var numberOfSlides = $Array.length(model.slides);
          return A2($Html.ol
                   ,_U.list([$TutorialStyles$Styles.stepperStyle])
                   ,A2($List.map,navigationButton,_U.range(0,numberOfSlides - 1)));
       };
       var location2action = function (uriParts) {
          var _p0 = uriParts;
          if (_p0.ctor === "::") {
             if (_p0._1.ctor === "::") {
                var _p1 = {ctor: "_Tuple2"
                          ,_0: $String.toInt(_p0._0)
                          ,_1: $String.toInt(_p0._1._0)};
                if (_p1.ctor === "_Tuple2" && _p1._0.ctor === "Ok" &&
                    _p1._1.ctor === "Ok") {
                   return _U.list([A2(MoveToPage,_p1._0._0,_p1._1._0)]);
                } else {
                   return _U.list([NoOp]);
                }
             } else {
                var _p2 = $String.toInt(_p0._0);
                if (_p2.ctor === "Ok") {
                   return _U.list([A2(MoveToPage,_p2._0,0)]);
                } else {
                   return _U.list([NoOp]);
                }
             }
       ...
       var delta2update = F2(function (old,$new) {
                             var same = _U.eq(old.currentStep,$new.currentStep) &&
                                        _U.eq(old.currentBuildUp,$new.currentBuildUp);
                             var _p3 = same;
                             if (_p3 === false) {
                                return $Maybe.Just($RouteHash.set(_U.list([$Basics.toString($new.currentStep)
                                                                          ,$Basics.toString($new.currentBuildUp)])));
                             } else {
                                return $Maybe.Nothing;
                             }
                          });
       var moveToPage = F3(function (page,buildup,model) {
                           return _U.update(model
                                           ,{currentStep: page,currentBuildUp: buildup});
                        });
       var handleArrows = F2(function (model,a) {
                             var lastPage = $Array.length(model.slides) - 1;
                             var tentativeBuildUp = model.currentBuildUp + a.x;
                             var slides = model.slides;
                             var previousPageMaxBuildUp = A2($DataModel.maxSlideBuildUp
                                                            ,model.currentStep - 1
                                                            ,slides);
                             var currentPageMaxBuildUp = A2($DataModel.maxSlideBuildUp
                                                           ,model.currentStep
                                                           ,slides);
                             var _p4 = _U.cmp(tentativeBuildUp,0) < 0 ? {ctor: "_Tuple2"
                                                                        ,_0: model.currentStep - 1
                                                                        ,_1: previousPageMaxBuildUp} : _U.cmp(tentativeBuildUp
                                                                                                             ,currentPageMaxBuildUp) > 0 ? {ctor: "_Tuple2"
                                                                                                                                           ,_0: model.currentStep
                                                                                                                                           + 1
                                                                                                                                           ,_1: 0}
                                       : {ctor: "_Tuple2",_0: model.currentStep,_1: tentativeBuildUp};
                             var nextPage = _p4._0;
                             var nextBuildUp = _p4._1;
                             var page = _U.cmp(nextPage,0) < 0 ? 0 : _U.cmp(nextPage
                                                                           ,lastPage) > -1 ? lastPage : nextPage;
                             var buildup = _U.cmp(nextBuildUp,0) < 0 ? 0 : _U.cmp(nextBuildUp
                                                                                 ,10) > 0 ? 10 : nextBuildUp;
                             var nextPageMaxBuildUp = A2($DataModel.maxSlideBuildUp
                                                        ,model.currentStep + 1
                                                        ,slides);
                             return A3(moveToPage,page,buildup,model);
                          });
       var update = F2(function (action,model) {
                       ...
                       switch (_p5.ctor)
                       {
                         ...
                         case "MoveToPage":
                           return {ctor: "_Tuple2"
                                  ,_0: A3(moveToPage,_p5._0,_p5._1,model)
                                  ,_1: $Effects.none};
                         case "Arrows":
                           return {ctor: "_Tuple2"
                                  ,_0: A2(handleArrows,model,_p5._0)
                                  ,_1: $Effects.none};
                         default:
                           if (_p5._0 === true) {
                              return {ctor: "_Tuple2"
                                     ,_0: A2(handleArrows,model,{x: 1,y: 0})
                                     ,_1: $Effects.none};
                           } else {
                              return {ctor: "_Tuple2"
                                     ,_0: A2(handleArrows,model,{x: 1,y: 0})
       ...
       var messages = $Signal.mailbox(NoOp);
       var currentPage =
       Elm.Native.Port.make(_elm).outboundSignal("currentPage"
                                                ,function (v) {
                                                   return v;
                                                }
                                                ,A2($Signal.map,function (n) { return 1;},messages.signal));
       var model = {currentStep: 0
                   ,currentBuildUp: 0
                   ,slides: $Array.fromList($Story.story)};
       var init = {ctor: "_Tuple2",_0: model,_1: $Effects.none};
       var Model = F3(function (a,b,c) {
                      return {currentStep: a,currentBuildUp: b,slides: c};
                   });
       var render = F2(function (buildup,pane) {
                       var $eval = $DataModel.evaluateBuildUp(buildup);
                       var _p6 = pane;
                       switch (_p6.ctor)
                       {
                         case "ShellPane":
                           return _U.list([A2($Html.div
                                             ,_U.list([$TutorialStyles$Styles.shellTabStyle])
                                             ,_U.list([A2($Html.span
                                                         ,_U.list([$TutorialStyles$Styles.titleStyle])
                                                         ,_U.list([$Html.text("Welcome to Alice O2")]))]))
                                          ,A2($Html.div
                                             ,_U.list([$TutorialStyles$Styles.shellStyle])
                                             ,_U.list([$Markdown.toHtml(A2($Basics._op["++"]
                                                                          ,"```\n"
                                                                          ,A2($Basics._op["++"],$eval(_p6._0.content),"```")))]))]);
                         case "EditorPane":
                           var _p7 = _p6._0;
                           return _U.list([A2($Html.div
                                             ,_U.list([$TutorialStyles$Styles.shellTabStyle])
                                             ,_U.list([A2($Html.span
                                                         ,_U.list([$TutorialStyles$Styles.titleStyle])
                                                         ,_U.list([$Html.text(_p7.filename)]))]))
                                          ,A2($Html.div
                                             ,_U.list([$TutorialStyles$Styles.editorStyle])
                                             ,_U.list([A2($Html.pre
                                                         ,_U.list([])
                                                         ,_U.list([A2($Html.code
                                                                     ,_U.list([$Html$Attributes.$class("lang-cpp")])
                                                                     ,_U.list([$Html.text($String.trim($eval(_p7.content)))]))]))]))]);
                         default:
                           return _U.list([$Markdown.toHtml($eval(_p6._0.content))]);
                       }
                    });
       var applyLayout = F2(function (buildup,layout) {
                            var _p8 = layout;
                            switch (_p8.ctor)
                            {
                              case "SinglePaneStep":
                                ...
                                return A2($Html.div
                                         ,_U.list([])
                                         ,_U.list([A2($Html.div
                                                     ,_U.list([$TutorialStyles$Styles.headerStyle])
                                                     ,A2(render,buildup,_p9.header))
                                                  ,A2($Html.div
                                                     ,_U.list([$TutorialStyles$Styles.bodyStyle])
                                                     ,_U.list([A2($Html.div
                                                                 ,_U.list([$Html$Attributes.$class("pure-g")])
                                                                 ,_U.list([A2($Html.div
                                                                             ,_U.list([$Html$Attributes.$class("pure-u-1-24")])
                                                                             ,_U.list([]))
                                                                          ,A2($Html.div
                                                                             ,_U.list([$Html$Attributes.$class("pure-u-22-24")])
                                                                             ,A2(render,buildup,_p9.pane))
                                                                          ,A2($Html.div
                                                                             ,_U.list([$Html$Attributes.$class("pure-u-1-24")])
                                                                             ,_U.list([]))]))]))]));
                              case "TwoPanesStep":
                                ...
                                return A2($Html.div
                                         ...
                                         ,_U.list([A2($Html.div
                                                     ,_U.list([$TutorialStyles$Styles.headerStyle])
                                                     ,A2(render,buildup,_p10.header))
                                                  ,A2($Html.div
                                                     ,_U.list([$TutorialStyles$Styles.bodyStyle])
                                                     ,_U.list([A2($Html.div
                                                                 ,_U.list([$Html$Attributes.$class("pure-g")
                                                                          ,$TutorialStyles$Styles.innerStyle])
                                                                 ,_U.list([A2($Html.div
                                                                             ,_U.list([$Html$Attributes.$class("pure-u-1-2")])
                                                                             ,_U.list([A2($Html.div
                                                                                         ,_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                                                                                   ,_0: "padding-right"
                                                                                                                                   ,_1: "15px"}]))])
                                                                                         ,A2(render,buildup,_p10.leftPane))]))
                                                                          ,A2($Html.div
                                                                             ,_U.list([$Html$Attributes.$class("pure-u-1-2")])
                                                                             ,_U.list([A2($Html.div
                                                                                         ,_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                                                                                   ,_0: "padding-left"
                                                                                                                                   ,_1: "15px"}]))])
                                                                                         ,A2(render,buildup,_p10.rightPane))]))]))]))
                                                     ...
                                                     ,_U.list([A2($Html.div
                                                                 ,_U.list([$Html$Attributes.$class("pure-g")
                                                                          ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                                                           ...
                                                                                                           ,_1: "center"}]))])
                                                                 ,_U.list([A2($Html.div
                                                                             ,_U.list([$TutorialStyles$Styles.innerStyle
                                                                                      ,$Html$Attributes.$class("pure-u-1")
                                                                                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                                                                       ,_0: "text-align"
                                                                                                                       ,_1: "center"}]))])
                                                                             ,_U.list([A2($Html.img
                                                                                         ,_U.list([$Html$Attributes.src(_p11.image)])
                                                                                         ,_U.list([$Html.text("A test image")]))]))]))]))
                                                  ,A2($Html.div,_U.list([]),_U.list([]))]));
                            }
                         });
       var currentBackground = function (model) {
          var maybeBackground = A2($Array.get
                                  ,model.currentStep
                                  ,model.slides);
          var _p12 = maybeBackground;
          if (_p12.ctor === "Just") {
             return A2($Html.div
                      ,_U.list([])
                      ,_U.list([A2(applyLayout,model.currentBuildUp,_p12._0)]));
          } else {
             return A2($Html.div,_U.list([]),_U.list([$Html.text("Error")]));
          }
       };
       var view = F2(function (address,model) {
                     return A2($Html.div
                              ...
                              ,_U.list([A2($Html.div
                                          ,_U.list([$Html$Attributes.$class("pure-g")
                                                   ,$TutorialStyles$Styles.topBarStyle])
                                          ,_U.list([A2($Html.div
                                                      ,_U.list([$Html$Attributes.$class("pure-u-1-2")])
                                                      ,_U.list([A2(title,address,model)]))
                                                   ,A2($Html.div
                                                      ,_U.list([$Html$Attributes.$class("pure-u-1-2")])
                                                      ,_U.list([stepper(model)]))]))
                                       ,A2($Html.div
                                          ,_U.list([$TutorialStyles$Styles.descriptionStyle])
                                          ,_U.list([currentBackground(model)]))]));
                  });
       var app = $StartApp.start({init: init
                                 ,update: update
                                 ,view: view
                                 ,inputs: _U.list([messages.signal
                                                  ,A2($Signal.map,Arrows,$Keyboard.arrows)
                                                  ,A2($Signal.map,Enter,$Keyboard.enter)])});
       var main = app.html;
       var tasks = Elm.Native.Task.make(_elm).performSignal("tasks"
                                                           ,app.tasks);
       var routeTasks =
       Elm.Native.Task.make(_elm).performSignal("routeTasks"
                                               ,$RouteHash.start({prefix: $RouteHash.defaultPrefix
                                                                 ,address: messages.address
                                                                 ,models: app.model
                                                                 ,delta2update: delta2update
                                                                 ,location2action: location2action}));
       return _elm.O2Tutorial.values = {_op: _op
                                       ,render: render
